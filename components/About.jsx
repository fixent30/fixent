...
const About = () => {
  return (
    <div
      name="About"
      className="flex flex-col lg:w-[80%] w-[95%] mx-auto lg:flex-row space-x-4 items-center my-4 space-y-5"
    >
      <img
        src="/logo.png"
        className="border-4 w-36 h-36 lg:w-40 lg:h-40 border-[#ee2b55] rounded-full cursor-pointer"
      />
      <div className="bg-[#ee2b55] w-full lg:text-xl p-4 lg:p-6 rounded-md text-white font-bold">
