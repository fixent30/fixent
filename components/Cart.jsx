      ...
      {user ? (
        <>
          ...
          <div className="overflow-y-auto ">
            {basket.map((item) => (
              <div
                className=" flex items-center justify-between border rounded-md my-4 px-4  py-2 border-gray-400 w-[80%] overflow-hidden"
                key={item.id}
              >
          ...
          <button
            ...
            className=" px-16 absolute z-10 bottom-5 left-10  rounded-md cursor-pointer bg-black text-white py-4 font-bold hover:scale-105 transition duration-100 ease-out"
          >
            Check Out{" "}
          </button>
        </>
